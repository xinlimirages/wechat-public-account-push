...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx3e4142801f232110',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '0a997282fca1438adb09b838656fb703',
  ...
  USERS: [
    {
      ...
      id: 'onlyp6KePjRKEGjl9Lvp9AouvRLQ',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '33l2RhuS9W1JqfPcbPEMQv7Ko9uNmmKaOYq09GF7XLM',
      // 所在省份
      province: '',
      // 所在城市
      city: '',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '小茁茁', year: '1996', date: '06-15',
        },
        {
        ...
        {
          type: '生日', name: '李鑫', year: '1996', date: '08-20',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2019-09-22' },
        // 结婚纪念日
        { keyword: 'marry_day', date: '2022-08-08' },
      ],
      // 课程表相关配置
  ...
  CALLBACK_TEMPLATE_ID: 'd7QCBXwSU5znQIX6VhLxmh9PbujhqHja-D3kb4u30ow',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'onlyp6BfVv7wzq2t0V67KUsk_M-4',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
